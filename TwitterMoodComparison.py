...
window1 = pyglet.window.Window(1200,600, visible=False)
...
def run():
    ...
    mode = raw_input("Please enter your operating mode (DEFAULT or COMPARISON). \n\nThe DEFAULT operating mode gives you a real time reading of the mood of all English tweets. \n\nThe COMPARISON operating mode will compare the mood's of tweets containing two keywords you specify. \n\nType DEFAULT or COMPARISON: ")
    mode = mode.lower()
    if mode == "default":
        term1list = publicKeyWords
        start1()

    elif mode == "comparison":
        term1 = raw_input("\nPlease enter the first search term: ")
        term2 = raw_input("\nPlease enter the second search term: ")
        ...
        print "Wow. Ok, it wasn't that hard. All you had to do was to type the word DEFAULT ot COMPARISON. You didn't even need to do it in all caps; you just had to spell it right. You know what? you don't get a second chance. Too bad. Exit the program and try again when you get a 3rd grade education."
...
def bar1():
    ...
    if mode != "default":
        ...
        label = pyglet.text.Label("Overall Mood",
                          font_name='Helvetica',
                          font_size=16, bold=True, color=(0, 0, 0, 255),
                          x=1050, y=height+25, anchor_x='right')
        label.draw()
